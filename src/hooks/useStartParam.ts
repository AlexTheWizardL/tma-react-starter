 ...
 *
 * @example
 * // URL: https://t.me/bot/app?startapp=page__profile__id__42
 * const { params, get } = useStartParam();
 * // params = { page: "profile", id: "42" }
 * // get("page") = "profile"
 *
 * @example
 * // URL: https://t.me/bot/app?startapp=referral_abc123
 * const { raw } = useStartParam();
 * // raw = "referral_abc123"
 */
